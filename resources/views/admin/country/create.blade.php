...
<div class="main">
    <div class="page-header">
        <div class="breadcrumb">
            ...
            <div class="breadcrumb-item"><a href="h-data-table.html"> Add Data Country </a></div>
        </div>
    </div>
    <div class="card">
        <div class="card-body">
            ...
            <form class="row g-3 mt-4" action="/admin/country" method="POST">
                @csrf
                <div class="col-md-6">
                    <label for="country_name" class="form-label">Country Name</label>
                    <input type="text" class="form-control" id="country_name" name="name" value="{{ old('name') }}" placeholder="Input Name of Country">
